...
print(f'No. of unique queries: {df['query'].nunique()} before normalization.')
df['query'] = df['query'].apply(normalize_query)
print(f'No. of unique queries: {df['query'].nunique()} after normalization.')
...
print(f'Unique categories: {num_of_unique_categories()}, and the current min_queries is {current_min_queries}.')
